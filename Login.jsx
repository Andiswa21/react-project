...
// import img from './src/assets/forest.jpg'
...
const Login = () => {
    ...
    return(
        <div className = "container-fluid " /*style={{backgroundImage : `url(${img})`, filter : "blur(0.5px)"}}*/>
            <div className = "row justify-content-center">
                <form className = "col-md-4 mt-3 pt-3 pb-3 border">
                    { "" !== notice &&
